        ...
        <p className="text-xs text-slate-600 mb-2">
          {STRIPE_ENABLED ? (
            <>
              ...
              buyers can pay you through Stripe's hosted checkout and we route the
              money to your connected account. For the others, you'll arrange the
              transfer with the buyer yourself once you've matched in chat.
            </>
          ) : (
